#ifndef PGP_WORDS_H
#define PGP_WORDS_H
// Canonical PGP biometric word list (Juola/Zimmermann): 256 even (2-syllable) + 256 odd (3-syllable).
// Byte value -> word, alternating even(byte0)/odd(byte1)/even(byte2)... Used for station fingerprints.
static const char* const kPgpEven[256] = {
...
static const char* const kPgpOdd[256]  = {
