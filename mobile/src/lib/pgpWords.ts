// Canonical PGP biometric word list (Juola/Zimmermann): 256 even + 256 odd.
// Byte -> word, alternating even(byte0)/odd(byte1)/even(byte2). Generated from
// receiver-basecamp/src/pgp_words.h — MUST stay byte-identical to the module's
// copy (module/src/pgp_words.h) so both ends show the same pairing fingerprint.
